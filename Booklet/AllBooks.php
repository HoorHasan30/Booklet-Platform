...
/* Popularity filter using average rating */
if ($ratingFilter !== "") {
...
if (!$genreResult) {
    die("Genre Query Error: " . mysqli_error($dbc));
}
...
if (!$authorResult) {
    die("Author Query Error: " . mysqli_error($dbc));
}
?>
            ...
            <?php while ($row = mysqli_fetch_assoc($result)) { ?>
                <div class="book-card">
                    ...
                    <div class="book-info">
                        ...
                        <a href="bookDetails.php?id=<?php echo $row['bookId']; ?>" class="view-more">View More</a>
                    </div>
                </div>
            <?php } ?>
        <?php } else { ?>
